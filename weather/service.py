...
from weather.schemas import QueryFields, WeatherSchema, WeatherCreateSchema
from geopy.geocoders import Nominatim
import json
from core.config_constants import API_URL
from core.configs import config
from core.exceptions.services_exceptions import NotAuthenticatedHTTPException, BadRequestHTTPException

class WeatherService:

    def __init__(self, repo: WeatherRepo):
        self.repo = repo
